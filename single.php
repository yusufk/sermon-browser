<div class="sermon-browser-results">
	...
	<?php bb_print_preacher_image($sermon["Sermon"]) ?><span class="preacher"><a href="<?php bb_print_preacher_link($sermon["Sermon"]) ?>"><?php echo stripslashes($sermon["Sermon"]->preacher) ?></a>, <?php echo date("j F Y", strtotime($sermon["Sermon"]->date)) ?></span><br />
	...
	<?php endforeach ?>
	<?php bb_print_preacher_description($sermon["Sermon"]) ?>
	...
	<?php for ($i = 0; $i < count($sermon["Sermon"]->start); $i++): echo add_bible_text ($sermon["Sermon"]->start[$i], $sermon["Sermon"]->end[$i], "esv"); endfor ?>
