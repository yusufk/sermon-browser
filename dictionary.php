...
$mdict = array(
	...
	'[first_passage]' => '<?php $foo = unserialize($sermon->start); $bar = unserialize($sermon->end); echo bb_get_books($foo[0], $bar[0]) ?>',
	'[files_loop]' => '<?php foreach ((array) $stuff["Files"] as $file): ?>',
	'[/files_loop]' => '<?php endforeach ?>',
	'[file]' => '<?php bb_print_file($file) ?>',
	'[urls_loop]' => '<?php foreach ((array) $stuff["URLs"] as $url): ?>',
	'[/urls_loop]' => '<?php endforeach ?>',
	'[url]' => '<?php bb_print_url($url) ?>',
...
$sdict = array(
	...
	'[passage]' => '<?php echo bb_get_books($sermon["Sermon"]->start[$i], $sermon["Sermon"]->end[$i]) ?>',
